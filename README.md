...
**DEMO:** [Prueba Técnica COMPENSAR](https://develop.d2w6lujnbw7o1r.amplifyapp.com/)

La documentación del Back (API), generada con postman se puede consultar en: [doc-compensar-api](https://documenter.getpostman.com/view/18192740/2sA3JNcMNz)
